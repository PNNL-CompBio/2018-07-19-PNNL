...
address: "Vista Room, Discovery Hall, Building 3400, Richland WA"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
humandate: "Jul 19-20, 2018"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Jeremy Zucker","Carlos Ortiz-Marrero", "Kyle Monson" ] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Kathe Todd-Brown"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes:       http://pad.software-carpentry.org/2018-07-19-PNNL-SWC      # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
...
{% endif %}
<h2 id="register">New registration system!</h2>
